...
import { ArrowBack, Add, Edit, Delete, Info, Inventory2, History, Print, Assessment, Payments } from '@mui/icons-material';
...
export default function IsEmriDetayPage() {
  ...
  useEffect(() => {
    const fetchStok = async () => {
      try {
        const res = await axios.get('/stok', { params: { limit: 1000 } });
        const data = res.data?.data ?? res.data;
