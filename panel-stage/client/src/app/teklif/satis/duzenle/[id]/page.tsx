...
export default function DuzenleSatisTeklifiPage() {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: teklifDetails?.teklifNo ? `${teklifDetails.teklifNo}` : 'SatisTeklifi',
  });
    ...
    <MainLayout>
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 2 }}>
          ...
          <Box sx={{ flex: 1 }}>
            <Typography variant="h4" fontWeight="bold" sx={{
              ...
              Satış Teklifini Düzenle
            </Typography>
            <Typography variant="body2" color="text.secondary">
              Teklif bilgilerini güncelleyin veya siparişe dönüştürün
            </Typography>
          </Box>
      ...
      <Paper component="fieldset" disabled={isReadOnly} sx={{ p: 3, borderRadius: 2 }}>
        <Stack spacing={3}>
          ...
          {/* Kalemler - Sipariş düzenleme sayfasındaki gibi */}
          <Box>
      ...
      >
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <table className="print-table">
            <tbody>
              <tr>
                <th style={{ width: '30%' }}>Cari Ünvanı</th>
