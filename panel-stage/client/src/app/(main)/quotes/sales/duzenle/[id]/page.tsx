...
export default function DuzenleSatisTeklifiPage() {
    ...
    const fetchData = async () => {
      try {
        ...
        setFormData({
          ...
          quoteType: quote.quoteType || 'SALE',
        ...
        addTab({ id: `quotes-sales-edit-${params.id}`, label: `Düzenle: ${quote.quoteNo}`, path: `/quotes/sales/duzenle/${params.id}` });
      } catch (error: any) {
