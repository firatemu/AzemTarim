            ...
            <Paper sx={{ p: 2, mb: 3 }}>
                <Stack direction="row" spacing={2} alignItems="center" justifyContent="space-between" flexWrap="wrap">
                    <Stack direction="row" spacing={2} alignItems="center">
                        <Typography variant="h6">Satın Alma İrsaliyesi Önizleme</Typography>
        ...
        >
            ...
            <Box sx={{ mb: 3, p: 2, bgcolor: '#f8f9fa', borderRadius: 1 }}>
                ...
                <Stack direction="row" spacing={3}>
                    <Box sx={{ flex: 1 }}>
                        <Typography variant="body2"><strong>Tedarikçi Kodu:</strong> {irsaliye.cari.cariKodu}</Typography>
                    ...
                    <Stack direction="row" spacing={3}>
                        <Box sx={{ flex: 1 }}>
                            <Typography variant="body2" sx={{ color: '#666' }}>
                                <strong>Tedarikçi Kodu:</strong> {irsaliye.cari.cariKodu}
                            </Typography>
                        </Box>
                        <Box sx={{ flex: 1 }}>
                            {irsaliye.cari.telefon && (
