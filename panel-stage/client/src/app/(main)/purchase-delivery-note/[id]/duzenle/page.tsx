...
export default function DuzenleSatinAlmaIrsaliyesiPage() {
  ...
  const handleSave = async () => {
    try {
      ...
      await axios.put(`/satin-alma-irsaliyesi/${irsaliyeId}`, {
      ...
      setTimeout(() => {
        router.push(`/satin-alma-irsaliyesi/${irsaliyeId}`);
      }, 1500);
    } catch (error: any) {
