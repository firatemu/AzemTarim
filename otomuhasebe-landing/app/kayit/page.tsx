...
export default function SignUpPage() {
  ...
  const validate = () => {
    ...
    // acceptTerms removed - API doesn't accept it
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300 placeholder:text-gray-400 ${errors.firstName ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-cyan-400'
                          }`}
                        placeholder="Adınız"
                      />
                    </div>
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 ${errors.lastName ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                          }`}
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 ${errors.email ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                          }`}
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 placeholder:text-gray-400 ${errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-teal-400'
                          }`}
                    ...
                    <div className="flex gap-4">
                      <label className="flex-1 group cursor-pointer">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`p-4 border-2 rounded-xl transition-all duration-300 ${companyType === 'LIMITED'
                            ? 'border-cyan-500 bg-gradient-to-br from-cyan-50 to-blue-50 shadow-lg'
                            : 'border-gray-300 hover:border-cyan-300'
                          }`}>
                          <div className="flex items-center gap-3">
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${companyType === 'LIMITED' ? 'border-cyan-500' : 'border-gray-300'
                              }`}>
                      ...
                      <label className="flex-1 group cursor-pointer">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`p-4 border-2 rounded-xl transition-all duration-300 ${companyType === 'SAHIS'
                            ? 'border-teal-500 bg-gradient-to-br from-teal-50 to-cyan-50 shadow-lg'
                            : 'border-gray-300 hover:border-teal-300'
                          }`}>
                          <div className="flex items-center gap-3">
                            <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${companyType === 'SAHIS' ? 'border-teal-500' : 'border-gray-300'
                              }`}>
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300 placeholder:text-gray-400 ${errors.invoiceCompanyName ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-cyan-400'
                              }`}
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            maxLength={10}
                            className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 ${errors.taxNumber ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                              }`}
                        ...
                        <div className="group">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              value={formData.firstName}
                              onChange={(e) => setFormData({ ...formData, firstName: e.target.value })}
                              className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 placeholder:text-gray-400 ${errors.firstName ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-teal-400'
                                }`}
                              placeholder="Adınız"
                            />
                          </div>
                        ...
                        <div className="group">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              value={formData.lastName}
                              onChange={(e) => setFormData({ ...formData, lastName: e.target.value })}
                              className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300 placeholder:text-gray-400 ${errors.lastName ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-cyan-400'
                                }`}
                              placeholder="Soyadınız"
                            />
                          </div>
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            maxLength={11}
                            className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 placeholder:text-gray-400 ${errors.tcKimlikNo ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-teal-400'
                              }`}
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 ${errors.taxOffice ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                            }`}
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300 placeholder:text-gray-400 ${errors.city ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-cyan-400'
                              }`}
                            placeholder="İl"
                          />
                        </div>
                      ...
                      <div className="group">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300 placeholder:text-gray-400 ${errors.district ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-teal-400'
                              }`}
                            placeholder="İlçe"
                          />
                        </div>
                    ...
                    <div className="group">
                      ...
                      <div className="relative">
                        ...
                        <textarea
                          ...
                          rows={3}
                          className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 resize-none ${errors.address ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                            }`}
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 placeholder:text-gray-400 ${errors.password ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-blue-400'
                          }`}
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-all duration-300 placeholder:text-gray-400 ${errors.confirmPassword ? 'border-red-400 bg-red-50' : 'border-gray-300 group-hover:border-cyan-400'
                          }`}
