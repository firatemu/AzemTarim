...
Object.defineProperty(exports, "BankCollectionHandler", {
    enumerable: true,
    get: function() {
        return BankCollectionHandler;
    }
});
...
let BankCollectionHandler = class BankCollectionHandler {
    async handle(dto, context) {
        ...
        for (const checkBillId of dto.selectedDocumentIds){
            ...
            (0, _statustransitionutil.assertLegalTransition)(checkBill.status, _client.CheckBillStatus.IN_BANK_COLLECTION);
            await tx.checkBill.update({
                where: {
                    id: checkBillId
                },
                data: {
                    status: _client.CheckBillStatus.IN_BANK_COLLECTION,
            ...
            await tx.checkBillLog.create({
                data: {
                    ...
                    toStatus: _client.CheckBillStatus.IN_BANK_COLLECTION,
                    journalId,
                    performedById,
...
BankCollectionHandler = _ts_decorate([
    (0, _common.Injectable)()
], BankCollectionHandler);

//# sourceMappingURL=bank-collection.handler.js.map