...
Object.defineProperty(exports, "DiscountHandler", {
    enumerable: true,
    get: function() {
...
let DiscountHandler = class DiscountHandler {
    async handle(dto, context) {
        ...
        for (const checkBillId of ids){
            ...
            (0, _statustransitionutil.assertLegalTransition)(checkBill.status, _client.CheckBillStatus.DISCOUNTED);
            await tx.checkBill.update({
                where: {
                    id: checkBillId
                },
                data: {
                    status: _client.CheckBillStatus.DISCOUNTED,
            ...
            await tx.checkBillLog.create({
                data: {
                    ...
                    toStatus: _client.CheckBillStatus.DISCOUNTED,
                    journalId,
                    performedById,
...
DiscountHandler = _ts_decorate([
    (0, _common.Injectable)()
], DiscountHandler);

//# sourceMappingURL=discount.handler.js.map