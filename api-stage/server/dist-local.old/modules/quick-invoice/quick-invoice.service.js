...
Object.defineProperty(exports, "QuickInvoiceService", {
    enumerable: true,
    get: function() {
        return QuickInvoiceService;
    }
});
...
let QuickInvoiceService = class QuickInvoiceService {
    /**
   * SOAP client oluşturur ve Authorization header ekler
   */ async createSoapClient(token) {
   ...
   */ async utilEncrypt(username, password, secretKey) {
        try {
   ...
   */ async login(usernameHash, passwordHash, apiKey) {
        try {
            const apiBase = process.env.HIZLI_API_BASE || 'https://econnecttest.hizliteknoloji.com.tr/HizliApi/RestApi';
   ...
   */ async autoLogin() {
        try {
            ...
            const encryptResult = await this.utilEncrypt(username, password, secretKey);
            // Debug: Response formatını log'la
            ...
            const loginResult = await this.login(usernameHash, passwordHash, apiKey);
            ...
            if (this.cachedToken) {
                ...
                return {
                    ...
                    token: this.cachedToken.substring(0, 50) + '...',
                    tokenLength: this.cachedToken.length,
                    hashedUsername: usernameHash.substring(0, 20) + '...',
                    hashedPassword: passwordHash.substring(0, 20) + '...',
   ...
   */ async getIncoming(appType = 1, dateType = 'CreatedDate', startDate, endDate, isNew = false, isExport = false, isDraft = false, takenFromEntegrator = 'ALL', branchCodes = null) {
        try {
   ...
   */ async getDocumentContent(uuid, type = 'XML') {
        try {
            if (!this.cachedToken || !this.isTokenValid()) {
                this.logger.log('Token yok veya geçersiz, otomatik login deneniyor...');
                await this.autoLogin();
            ...
            fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                ...
                body: JSON.stringify({
                    location: 'quick-invoice.service.ts:580',
                    message: 'GetDocumentFile SOAP call',
                    data: {
                        uuid,
            ...
            return new Promise((resolve, reject)=>{
                ...
                fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                    ...
                    body: JSON.stringify({
                        location: 'quick-invoice.service.ts:586',
                        message: 'GetDocumentFile params',
                        data: {
                            uuid,
                            paramFormat: 'UUID/Type'
                        },
                        timestamp: Date.now(),
                        sessionId: 'debug-session',
                        runId: 'run3',
                ...
                fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                    ...
                    body: JSON.stringify({
                        location: 'quick-invoice.service.ts:595',
                        message: 'GetDocumentFile params before call',
                        data: {
                            params,
                            uuid
                        },
                ...
                // #endregion
                client.GetDocumentFile(params, (err, result)=>{
                    // #region agent log
                    fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                        method: 'POST',
                        headers: {
                        ...
                        body: JSON.stringify({
                            location: 'quick-invoice.service.ts:592',
                            message: 'GetDocumentFile SOAP response',
                            data: {
                                hasError: !!err,
                                hasResult: !!result,
                    ...
                    if (err) {
                        ...
                        fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                            ...
                            body: JSON.stringify({
                                location: 'quick-invoice.service.ts:597',
                                message: 'GetDocumentFile error',
                                data: {
                    ...
                    fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                        ...
                        body: JSON.stringify({
                            location: 'quick-invoice.service.ts:605',
                            message: 'GetDocumentFile soapResult keys',
                            data: {
                                soapResultKeys: Object.keys(soapResult || {}),
                                hasGetDocumentFileResult: !!result?.GetDocumentFileResult
                            },
                            timestamp: Date.now(),
                            sessionId: 'debug-session',
                            runId: 'run3',
                    ...
                    fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                        ...
                        body: JSON.stringify({
                            location: 'quick-invoice.service.ts:625',
                            message: 'GetDocumentFile content search result',
                            data: {
                                foundContent: !!documentContent,
                                soapResultType: typeof soapResult
                            },
                            timestamp: Date.now(),
                            sessionId: 'debug-session',
                            runId: 'run3',
                    ...
                    if (!isSucceeded) {
                        ...
                        fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                            ...
                            body: JSON.stringify({
                                location: 'quick-invoice.service.ts:625',
                                message: 'GetDocumentFile failed',
                                data: {
                                    message,
                                    isSucceeded
                                },
                    ...
                    if (!documentContent) {
                        ...
                        fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                            ...
                            body: JSON.stringify({
                                location: 'quick-invoice.service.ts:633',
                                message: 'GetDocumentFile content not found',
                                data: {
                                    soapResultKeys: Object.keys(soapResult || {})
                                },
                                timestamp: Date.now(),
                    ...
                    fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                        ...
                        body: JSON.stringify({
                            location: 'quick-invoice.service.ts:639',
                            message: 'GetDocumentFile success',
                            data: {
            ...
            fetch('http://localhost:7244/ingest/fde0823c-7edc-4232-a192-3b97a49bcd3d', {
                ...
                body: JSON.stringify({
                    location: 'quick-invoice.service.ts:653',
                    message: 'GetDocumentFile exception',
                    data: {
   ...
   */ async getGibUserList(appType, type, identifier) {
        try {
            if (!this.cachedToken) {
   ...
   */ async sendInvoiceModel(inputInvoices) {
        try {
            if (!this.cachedToken) {
                throw new Error('Token not found. You must login first.');
            }
            ...
            const response = await _axios.default.post(url, inputInvoices, {
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${this.cachedToken}`
                }
    ...
    constructor(){
        this.logger = new _common.Logger(QuickInvoiceService.name);
        this.soapUrl = process.env.HIZLI_SOAP_URL || 'https://econnecttest.hizliteknoloji.com.tr/Services/HizliService.svc?wsdl';
        this.cachedToken = null;
        this.cachedHashedUsername = null;
        this.cachedHashedPassword = null;
        this.tokenExpiresAt = null;
        this.encryptionStatus = 'not_attempted';
        this.loginStatus = 'not_attempted';
    }
};
QuickInvoiceService = _ts_decorate([
    (0, _common.Injectable)()
], QuickInvoiceService);

//# sourceMappingURL=quick-invoice.service.js.map