...
Object.defineProperty(exports, "BankAccountModule", {
    enumerable: true,
    get: function() {
...
const _bankaccountcontroller = require("./bank-account.controller");
...
BankAccountModule = _ts_decorate([
    (0, _common.Module)({
        imports: [
        ...
        controllers: [
            _bankaccountcontroller.BankAccountController
        ],
        providers: [
