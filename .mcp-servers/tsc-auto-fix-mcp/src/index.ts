...
async function applyPrismaMappingFix(filePath: string, targetField: string, replacementField: string) {
    ...
    try {
        switch (request.params.name) {
            ...
            case "apply_prisma_mapping_fix":
                const { filePath, targetField, replacementField } = request.params.arguments as any;
