...
- **Global Standartlar**: `ui-ux-design-standards` skill dosyasını OKUYUN.
- **Density**: DataGrid `comfortable`.
- **Empty States**: `<EmptyState />` kullanın.
- **Micro-Interactions**: Row action'ları sadece hover'da gösterin.
